 ...
 *
 * Features:
 * - API key from GNOME Keyring (secret-tool) for secure storage
 ...
 *   pi -e ~/.config/pi/agent/extensions/custom-anthropic
 */
...
// =============================================================================
// Secret Key Management (GNOME Keyring via secret-tool)
// =============================================================================

/**
 * Get API key from GNOME Keyring using secret-tool
 * Falls back to environment variable if secret-tool is not available
 */
function getApiKey(): string {
	...
	return process.env.CUSTOM_ANTHROPIC_API_KEY || "";
}
...
function streamCustomAnthropic(
	...
	(async () => {
		...
		try {
			// Get API key from secret-tool or environment
