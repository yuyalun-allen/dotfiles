...
Changes should be limited to the current folder otherwise you should ask for permissions.
You should be responsible for your actions (e.g. release file resources used in `/tmp`). 
